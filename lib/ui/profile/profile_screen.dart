...
class ProfileScreen extends StatefulWidget {
  const ProfileScreen(
      {super.key, required this.contactModelSql, required this.deleteListener});
...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  onPressed: () {
                    _updateSingleContact(
                        ContactModelSql(
                            phone: widget.contactModelSql.phone,
                            name: widget.contactModelSql.name,
                            surName: widget.contactModelSql.surName), () {
                      _updateContacts();
                    });
                    _updateContacts();
                  },
            ...
            Text(
              '${widget.contactModelSql.name} ${widget.contactModelSql.surName}',
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    await launchUrl(
                        Uri.parse("sms:${widget.contactModelSql.phone}?body="));
                  },
                  child: Container(
                    height: 40,
                    width: 40,
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text(
                'Are you sure you want to remove ${widget.contactModelSql.name} ${widget.contactModelSql.surName} from your contacts?'),
            actions: <Widget>[
              TextButton(
  ...
  _updateSingleContact(
      ContactModelSql contactModelSql, VoidCallback deleteListener) {
